...
params = {
    "evolution": {
        ...
        "evaluation": {
            "type": "all-vs-kbest",  # all-vs-all | random | all-vs-best | all-vs-kbest | all-vs-species-best
            "best_size": 2,
            "iterations": 1,
        ...
        "fitness": {
            "discriminator": "AUC",  # AUC | loss | random
    ...
    "gan": {
        "dataset": "FashionMNIST",  # CelebA64Cropped | CelebA32Cropped | MNIST | FashionMNIST | CIFAR10
